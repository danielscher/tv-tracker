...
/// </summary>
public class MediaView(Guid mediaId,int tmdbId, MediaType type, string title, string? poster, int? rating, WatchStatus? status)
{
    ...
    public WatchStatus Status = status ?? WatchStatus.None;
}